...
impl BlockRegistry {
    ...
    fn register_defaults(&mut self) {
        ...
        self.register(BlockType::Air, BlockMaterial {
            name: "Air",
        ...
        self.register(BlockType::Stone, BlockMaterial {
            name: "Stone",
        ...
        self.register(BlockType::Dirt, BlockMaterial {
            name: "Dirt",
        ...
        self.register(BlockType::Grass, BlockMaterial {
            name: "Grass",
        ...
        self.register(BlockType::Sand, BlockMaterial {
            name: "Sand",
        ...
        self.register(BlockType::Water, BlockMaterial {
            name: "Water",
        ...
        self.register(BlockType::Wood, BlockMaterial {
            name: "Wood",
            textures: FaceTextures::new(
        ...
        // Leaves - green, soft
        self.register(BlockType::Leaves, BlockMaterial {
            name: "Leaves",
        ...
        self.register(BlockType::Coal, BlockMaterial {
            name: "Coal",
        ...
        // Iron - metallic gray
        self.register(BlockType::Iron, BlockMaterial {
            name: "Iron",
        ...
        // Gold - golden yellow
        self.register(BlockType::Gold, BlockMaterial {
            name: "Gold",
        ...
        // Snow - white, soft
        self.register(BlockType::Snow, BlockMaterial {
            name: "Snow",
...
pub mod generation {
    ...
    pub fn get_block_for_height(height: usize, _max_height: usize, y: usize, noise_value: f64) -> BlockType {
    ...
    pub fn get_biome_block(base_block: BlockType, biome_noise: f64, height: usize, y: usize) -> BlockType {
        let surface_level = height.saturating_sub(1);
